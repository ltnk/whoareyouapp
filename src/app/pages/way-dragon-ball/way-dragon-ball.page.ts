...
@Component({
  ...
  templateUrl: "./way-dragon-ball.page.html",
  styleUrls: ["./way-dragon-ball.page.scss"],
})
export class WayDragonBallPage implements OnInit {
  ...
  constructor(
    ...
    private dragonBallQuizService: DragonBallService
  ) {}
