...
import { DeathNoteQuizService } from "src/app/services/death-note-quiz.service";
import { NavController } from "@ionic/angular";

@Component({
  selector: "app-way-death-note",
  templateUrl: "./way-death-note.page.html",
  styleUrls: ["./way-death-note.page.scss"],
})
export class WayDeathNotePage implements OnInit {
  ...
  constructor(
    public deathNoteQuizService: DeathNoteQuizService,
